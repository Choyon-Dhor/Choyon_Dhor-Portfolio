...
const Contact = () => {
  ...
  const iconMap = { FiMail, FiGithub, FiLinkedin }
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mt-3">
            Let&apos;s <span className="neon-gradient-text">{contactContent.title}</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            >
              ...
              <div>
                <p className="text-sm text-gray-300">{contactContent.locationLabel}</p>
                <p className="text-xs text-gray-500">{contactContent.locationSubtext}</p>
              </div>
            </motion.div>
            ...
            >
              <span className="w-2 h-2 bg-green-400 rounded-full animate-badge-pulse" />
                <span className="text-sm text-gray-300">{contactContent.responseText}</span>
            </motion.div>
          </motion.div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 glass-purple rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      {(() => {
                        ...
                        return <Icon className="w-6 h-6 text-neon-purple-light" />
                      })()}
                    </div>
